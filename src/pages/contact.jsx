...
//         >
//           {[
//             { title: "Address", value: contactInfo.address },
//             { title: "Phone", value: contactInfo.phone },
//             { title: "Email", value: contactInfo.email },
//           ].map((item, index) => (
//             <div
//               key={index}
    ...
    <div className="bg-gradient-to-br from-blue-50 to-white min-h-screen py-12 px-4 md:px-20">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-start">
        ...
        >
          {[{ title: "Address", value: contactInfo.address },
            { title: "Phone", value: contactInfo.phone },
            { title: "Email", value: contactInfo.email }].map((item, index) => (
            <div
              key={index}
              className="bg-blue-100 p-5 rounded-xl shadow-md hover:scale-[1.02] transition-all"
            >
