...
//               Krishna Public School focuses on the holistic development of
//               students, providing academic excellence, state-of-the-art
//               facilities, and a nurturing environment that empowers young minds
//               to grow, innovate, and lead.
//             </p>
//             <Link to="/about">
//               <button className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-full transition duration-300">
//                 Read More
//               </button>
//             </Link>
//           </motion.div>
...
// {/* 🏆 Toppers Section with Infinite Scroll */}
...
//       className="text-3xl md:text-4xl font-extrabold text-blue-900 mb-12 underline decoration-blue-400"
//     >
